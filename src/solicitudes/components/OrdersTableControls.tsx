...
//   };
//   const debouncedSetPage = useDebouncedCallback(handlePageChange, 1000);
...
//             step={1}
//             min={1}
//             max={result.data.pagination.pages}
//             value={pseudoPagestr}
//             onChange={(e) => {
//               setPseudoPagestr(e.target.value);
//               debouncedSetPage(e.target.value);
//             }}
//             disabled={result.data.pagination.pages === 1}
//           />
//           <p>de</p>
//           <p>{result.data.pagination.pages}</p>
//         </div>
//       </div>
//     )
//   );
