...
export const ServiciosTableHeader: FC = () => (
  <TableHeader className="[&_tr]:border-b border-gray-200">
    <TableRow className="hover:bg-white">
      ...
      <TableHead className="text-gray-500 font-medium">Precio Regular</TableHead>
      <TableHead className="text-gray-500 font-medium">Condicional de Precio</TableHead>
      <TableHead className="text-gray-500 font-medium">Observaciones</TableHead>
