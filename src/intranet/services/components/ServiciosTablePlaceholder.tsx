      ...
      {Array.from({ length: rows }).map((_, idx) => (
        ...
        >
          <TableCell className="py-3">
            <Skeleton className="h-4 w-36 bg-gray-50" />
          </TableCell>
          <TableCell>
            <Skeleton className="h-4 w-48 bg-gray-50" />
          </TableCell>
          <TableCell>
            <Skeleton className="h-4 w-16 bg-gray-50" />
          </TableCell>
          <TableCell>
            <Skeleton className="h-4 w-24 bg-gray-50" />
          </TableCell>
          <TableCell>
            <Skeleton className="h-4 w-56 bg-gray-50" />
          </TableCell>
          <TableCell className="text-center">
            <Skeleton className="h-6 w-24 mx-auto rounded-full bg-gray-50" />
          </TableCell>
          <TableCell className="text-center">
